...
function MiniProject({ project, index }) {
  return (
    <li className="group w-full relative overflow-hidden md:w-11/12">
      ...
      <div className="flex justify-center items-center absolute top-0 left-0 w-full h-full  bg-blackest-color bg-opacity-40 transition duration-300 block group-hover:bg-opacity-0 group-hover:hidden">
